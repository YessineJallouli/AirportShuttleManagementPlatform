...
import { emailRegex, isContainsLowercase, isWhiteSpace, 
    isContainsUppercase, isContainsNumber, isContainsSymbol, isValidLength
    ...
    return(
        ...
        >
           ...
           <MainHeader/>
            ...
            <View 
                style= {{width: '80%'}}>
                {!emailValid && <Text style = {{fontWeight : 'bold', color : 'red'}}>Email is not valid</Text>}
            </View>
            {/* shows only when the Email is not valid */}
            ...
            <View style= {{width: '80%'}}>
                {!pwdMatch && <Text style = {{fontWeight : 'bold', color : 'red'}}>Password does not match</Text>}
            </View>
            {/* shows only when passwords don't match*/}
